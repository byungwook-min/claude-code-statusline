...
function main() {
  ...
  // Only heal when the HUD is actually installed on disk.
  if (!existsSync(join(configDir, "statusline", "hud.mjs"))) return;
  const desired = `node ${CONFIG_TOKEN}/statusline/hud.mjs`;
